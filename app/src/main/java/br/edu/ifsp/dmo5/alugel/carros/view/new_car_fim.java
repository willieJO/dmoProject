...
public class new_car_fim extends AppCompatActivity  implements PhotoCadastroMVP.View{
    private ImageView photoImageView;
    private Button tirarFoto;
    private Button salvar;
    private Carro carro;
    private String base64Photo;
    private PhotoCadastroPresenter presenter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        presenter = new PhotoCadastroPresenter(this);
